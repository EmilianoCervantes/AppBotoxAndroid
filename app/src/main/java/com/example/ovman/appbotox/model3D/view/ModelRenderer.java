...
import com.example.ovman.appbotox.model3D.entities.Camera;
import com.example.ovman.appbotox.model3D.model.Object3D;
...
import com.example.ovman.appbotox.model3D.model.Object3DImpl;
import com.example.ovman.appbotox.model3D.services.SceneLoader;
import com.example.ovman.appbotox.model3D.util.GLUtil;
...
public class ModelRenderer implements GLSurfaceView.Renderer {
	...
	public void onSurfaceCreated(GL10 unused, EGLConfig config) {
		...
		/** Background color tambien comentado en ZonesActivity
        float[] backgroundColor = main.getZonesActivity().getBackgroundColor();
	...
	public void onDrawFrame(GL10 unused) {
		...
		SceneLoader scene = main.getZonesActivity().getScene();
		if (scene == null) {
			// scene not ready
			return;
		}
