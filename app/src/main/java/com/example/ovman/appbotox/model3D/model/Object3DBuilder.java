package com.example.ovman.appbotox.model3D.model;
...
import com.example.ovman.appbotox.model3D.services.WavefrontLoader.FaceMaterials;
import com.example.ovman.appbotox.model3D.services.WavefrontLoader.Faces;
import com.example.ovman.appbotox.model3D.services.WavefrontLoader.Material;
import com.example.ovman.appbotox.model3D.services.WavefrontLoader.Materials;
import com.example.ovman.appbotox.model3D.services.WavefrontLoader.Tuple3;
import com.example.ovman.appbotox.model3D.services.collada.loader.ColladaLoader;
import com.example.ovman.appbotox.model3D.services.stl.STLLoader;
import com.example.ovman.appbotox.model3D.services.wavefront.WavefrontLoader2;
import com.example.ovman.appbotox.util.math.Math3DUtils;
...
public final class Object3DBuilder {
	...
	static {
		System.setProperty("java.protocol.handler.pkgs", "import com.example.ovman.appbotox.util.url|"+ System.getProperty("java.protocol.handler.pkgs"));
	...
	//public static void loadV6AsyncParallel(final Activity parent, final URL url, final File file, final String assetsDir, final String assetName, final Callback callback) {
...
class BoundingBox {
	 ...
	 */
	public BoundingBox(com.example.ovman.appbotox.model3D.entities.BoundingBox box, float[] color) {
		// initialize vertex byte buffer for shape coordinates
	...
	private void calculateVertex(com.example.ovman.appbotox.model3D.entities.BoundingBox box) {
		//@formatter:off
