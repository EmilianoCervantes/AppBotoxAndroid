package com.example.ovman.appbotox.model3D.services;
...
import com.example.ovman.appbotox.model3D.animation.Animator;
import com.example.ovman.appbotox.model3D.collision.CollisionDetection;
import com.example.ovman.appbotox.model3D.model.Object3DBuilder;
import com.example.ovman.appbotox.model3D.model.Object3DBuilder.Callback;
import com.example.ovman.appbotox.model3D.model.Object3DData;
//import com.example.ovman.appbotox.model3D.view.ModelActivity;
import com.example.ovman.appbotox.util.url.android.Handler;
...
public class SceneLoader {
	 ...
	 * Parent component
	 */
	protected final ZonesActivity parent;
	/**
	 ...
	 *
	 * Modificado por Emiliano para que no aparezca desde un inicio (false)
	 */
	...
	public SceneLoader(ZonesActivity main) {
		this.parent = main;
	}
	...
	public void init() {
		...
		if (parent.getParamFile() != null || parent.getParamAssetDir() != null) {
			...
			// Create asset url
            /**URL es solo necesario para archivis .stl y .dae
             * Clases ZonesActivity, SceneLoader y Object3DBuilder comentados
             */
			/**final URL url;
			try {
				if (parent.getParamFile() != null) {
                    ...
                    Log.i("SceneDir", "El dir recibido es: "+parent.getParamAssetDir());
                    Log.i("SceneDir", "El filename recibido es: "+parent.getParamAssetFilename());
					...
					Log.i("URL", "Url es: "+url);
                    Log.i("Debug", "debug step url");
				}
			...
			//Object3DBuilder.loadV6AsyncParallel(parent, url, parent.getParamFile(), parent.getParamAssetDir(), parent.getParamAssetFilename(), new Callback() {
            Object3DBuilder.loadV6AsyncParallel(parent, parent.getParamFile(), parent.getParamAssetDir(), parent.getParamAssetFilename(), new Callback() {
	...
	public boolean isDrawBoundingBox() {
		return drawBoundingBox; //variable linea 58
	}
